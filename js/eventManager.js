...
EventManager.prototype._isTouchDevice = function() {  
  return 'ontouchstart' in window;  
}  
  
EventManager.prototype._fitTouchDevice = function() {  
    ...
    document.addEventListener("touchmove", function(e) {
		...
		simMouseEvt("mousemove", e.target, e.changedTouches[0]);   
    });  
...
//EventManager._fitTouchDevice();
Game.EventManager= new EventManager();
Game.EventManager._fitTouchDevice();
})();