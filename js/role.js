...
Hero.prototype.init=function(){
	...
	Game.EventManager.registerBean(this,["mousedown"],Control.heroOn,true);
	Game.EventManager.registerBean(this,["mouseup"],Control.heroOut,false);
	Game.EventManager.registerBean(this,["mousemove"],Control.heroMove,false);
...
Guard.prototype.init=function(){
	...
	this.test=new Animation({
		img:"super",
		scale:this.scale,
		frames:[[0,0,130,159,100],[130,0,130,159,100],[260,0,130,159,100],[390,0,130,159,100],[520,0,130,159,100]]
	});
	this.currentAnim=this.quite;
	this.currentAnim.init();
}
...
Boss.prototype.init=function(){
	...
	Game.EventManager.registerMyEvent(this,["changeSecond"],Control.bossChangeSecond);
	Game.EventManager.registerMyEvent(this,["changeThree"],Control.bossChangeThree);
}
...
Boss.prototype.backState=function(){
...
function EnemyA(){
	...
	this.r=50;
	this.life=150;
	this.marginal =600+Math.random()*150 ; /*临界点*/
	this.blood=150;
	this.bloodL=30;
	this.bloodW=5;
}
